...
# Set frequency
gen.write(':FREQUENCY 15M') # Frquency of Input Transducer 
...
# set burst
gen.write('OUTPUT:BURST ON')

#set cycle 
gen.write('CYCLE 1') # want 1 cycle, if more cycle  
...
plt.title('channel 1 Measurements') # plot label
